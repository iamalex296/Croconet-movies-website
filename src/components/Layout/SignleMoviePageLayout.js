...
const SignleMoviePageLayout = ({ singleMovieDetailsObj, movieVideo }) => {
    ...
    >
      <div
        style={{
          ...
          padding: "0px 30px",
          backgroundImage:
            "url(" + poster_URL + singleMovieDetailsObj.backdrop_path + ")",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
        }}
      >
        <div
          style={{ width: "70%", heigth: "100%", margin: "0", padding: "0" }}
        >
          {movieVideo}
        </div>
      </div>
      ...
      >
        <img
          ...
          src={poster_URL + singleMovieDetailsObj.poster_path}
          alt="moviePoster"
        />
        <div
          style={{
        ...
        >
          <p>{singleMovieDetailsObj.title}</p>
          <p>
            ენა:{" "}
          ...
          <p>შემოსავალი: {singleMovieDetailsObj.revenue}$</p>
          <p>აღწერა: {singleMovieDetailsObj.overview}</p>
        </div>
      </div>
    </Template>
  );
